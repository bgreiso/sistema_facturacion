...
$total = $conn->query("SELECT COUNT(*) as count FROM clients")->fetch_assoc()['count'];
...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0">
            <i class="fas fa-users me-2" style="color: #f72585;"></i> 
            <span style="color: #212529;">Gestión de Clientes</span>
        </h2>
        <div>
            <a href="add.php" class="btn btn-danger btn-module">
                ...
                <table class="table table-module">
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                <td class="align-middle client-name"><?= htmlspecialchars($client['name']) ?></td>
                                <td class="align-middle"><?= htmlspecialchars($client['ruc']) ?></td>
                                <td class="align-middle"><?= htmlspecialchars($client['phone']) ?></td>
                                <td class="align-middle"><?= htmlspecialchars($client['email']) ?></td>
                                <td class="text-end align-middle">
                                    <div class="d-inline-flex">
                                        <a href="<?= BASE_URL ?>/modules/clients/edit.php?id=<?= $client['id'] ?>" 
                                           class="action-btn btn btn-sm btn-warning me-2" title="Editar">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="<?= BASE_URL ?>/modules/clients/delete.php?id=<?= $client['id'] ?>" 
                                           class="action-btn btn btn-sm btn-danger" title="Eliminar"
